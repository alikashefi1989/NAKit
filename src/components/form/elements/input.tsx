...
import { CSSProperties, HTMLInputTypeAttribute, KeyboardEvent, MouseEvent, useCallback, useMemo } from 'react';
...
export interface InputProps<EntityModel extends Record<string, any>> extends FormElementBaseProps<EntityModel> {
